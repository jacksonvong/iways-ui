<template>
  ...
  <div
    ...
    :class="[
      'iw-date-editor--' + type,
      pickerSize ? `iw-range-editor--${ pickerSize }` : '',
      pickerDisabled ? 'is-disabled' : '',
      pickerVisible ? 'is-active' : ''
    ]"
    class="iw-date-editor iw-range-editor iw-input__inner"
    ...
    <input
      ...
      :name="name && name[0]"
      autocomplete="off"
      class="iw-range-input"
      @input="handleStartInput"
      @change="handleStartChange"
      @focus="handleFocus">
    <slot name="range-separator">
      <span class="iw-range-separator">{{ rangeSeparator }}</span>
    </slot>
    <input
...
import { formatDate, parseDate, isDateObject, getWeekNumber } from '@iways-ui/src/utils/date-util'
