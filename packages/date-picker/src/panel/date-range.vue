    ...
    <div
      ...
      <div class="iw-picker-panel__body-wrapper">
        ...
        <div class="iw-picker-panel__body">
          <div v-if="showTime" class="iw-date-range-picker__time-header">
            <span class="iw-date-range-picker__editors-wrap">
              <span class="iw-date-range-picker__time-picker-wrap">
                <iw-input
                  ref="minInput"
                  :disabled="rangeState.selecting"
                  :placeholder="t('iw.datepicker.startDate')"
                  :value="minVisibleDate"
                  size="small"
                  class="iw-date-range-picker__editor"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span v-clickoutside="handleMinTimeClose" class="iw-date-range-picker__time-picker-wrap">
                <iw-input
                  :disabled="rangeState.selecting"
                  :placeholder="t('iw.datepicker.startTime')"
            ...
            <span class="iw-icon-arrow-right"/>
            <span class="iw-date-range-picker__editors-wrap is-right">
              <span class="iw-date-range-picker__time-picker-wrap">
                <iw-input
                  :disabled="rangeState.selecting"
                  :placeholder="t('iw.datepicker.endDate')"
              ...
              <span v-clickoutside="handleMaxTimeClose" class="iw-date-range-picker__time-picker-wrap">
                <iw-input
                  :disabled="rangeState.selecting"
                  :placeholder="t('iw.datepicker.endTime')"
          ...
          <div class="iw-picker-panel__content iw-date-range-picker__content is-left">
            <div class="iw-date-range-picker__header">
              ...
              <button
                type="button"
                class="iw-picker-panel__icon-btn iw-icon-arrow-left"
                @click="leftPrevMonth"/>
              <button
                v-if="unlinkPanels"
              ...
              <button
                ...
                type="button"
                class="iw-picker-panel__icon-btn iw-icon-arrow-right"
                @click="leftNextMonth"/>
              <div>{{ leftLabel }}</div>
            </div>
...
export default {
  ...
  components: { TimePicker, DateTable, IwInput, IwButton },
  mixins: [Locale],
