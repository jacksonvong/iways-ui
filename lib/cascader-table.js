...
/* harmony default export */ var cascader_table_itemvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleParentChange: function handleParentChange(item) {
      if (item.parent) {
        var parent = Object(util["g" /* findInArray */])('key', item.parent[this.optionProps.value], this.data, this.optionProps.children, item.parent.level);
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/cascader-table/src/cascader-table-item.vue"
/* harmony default export */ var cascader_table_item = (component.exports);
...
/* harmony default export */ var cascader_tablevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    deep: function deep() {
      return this.data.length ? Object(util["n" /* treeDeep */])(this.data) : 0;
    },
  ...
  methods: {
    ...
    initData: function initData() {
      ...
      this.datas = Object(util["i" /* getTree */])(data, {
...
var cascader_table_component = Object(componentNormalizer["a" /* default */])(
...
/* concated harmony reexport default */__webpack_require__.d(__webpack_exports__, "default", function() { return cascader_table; });
