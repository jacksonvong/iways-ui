<template>
  <transition name="iw-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      :class="popperClass"
      class="iw-time-panel iw-popper">
      <div :class="{ 'has-seconds': showSeconds }" class="iw-time-panel__content">
        <time-spinner
          ref="spinner"
...
import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from '@iways-ui/src/utils/date-util'
