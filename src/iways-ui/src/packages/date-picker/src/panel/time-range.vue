<template>
  <transition
    ...
    <div
      v-show="visible"
      :class="popperClass"
      class="iw-time-range-picker iw-picker-panel iw-popper">
      <div class="iw-time-range-picker__content">
        <div class="iw-time-range-picker__cell">
          <div class="iw-time-range-picker__header">{{ t('iw.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="iw-time-range-picker__body iw-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="iw-time-range-picker__cell">
          <div class="iw-time-range-picker__header">{{ t('iw.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="iw-time-range-picker__body iw-time-panel__content">
            <time-spinner
      ...
      <div class="iw-time-panel__footer">
        <button
          type="button"
          class="iw-time-panel__btn cancel"
          @click="handleCancel()">{{ t('iw.datepicker.cancel') }}</button>
        <button
          :disabled="btnDisabled"
          type="button"
          class="iw-time-panel__btn confirm"
          @click="handleConfirm()">{{ t('iw.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
