        ...
        <div :class="[{'is-focus': !disabled&&visible, 'is-disabled': disabled}, 'iw-input', 'iw-input--' + iwSize]" :style="'width:'+referenceWidth+'px'">
          <div v-if="popover==='IwPopover'" class="iw-input__inner">
            <span v-if="multiple&&checkedOptions[checkedTab]&&checkedOptions[checkedTab].length>0" class="iw-input__value">
              <input v-if="checkedOptions[checkedTab].length>1" :value="'已选(' + checkedOptions[checkedTab].length +')'" :style="'width:'+(referenceWidth-36)+'px'" disabled>
              <input v-else :value="checkedOptions[checkedTab][0][optionProps.label]" :style="'width:'+(referenceWidth-36)+'px'" disabled>
            </span>
            <span v-else-if="!multiple&&checkedOptions[checkedTab]&&checkedOptions[checkedTab].length" class="iw-input__value">
              <input :value="checkedOptions[checkedTab][checkedOptions.length-1][optionProps.label]" :style="'width:'+(referenceWidth-36)+'px'" disabled>
            </span>
